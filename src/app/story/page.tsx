...
export default function OurStory() {
  ...
  const t = {
    en: {
      heroHeadline: "I was spending €200 more than I needed to. Every. Single. Month.",
      heroSubtitle: "Here's how I fixed it.",
      block1Title: "The Arrival",
      block1Text: "Three years ago, I moved from India to Germany. I spoke zero German. Shopping was terrifying. I'd stand in Aldi staring at labels I couldn't read, grabbing whatever looked familiar, praying it wasn't cat food. 😰",
      ...
      block3Continues: "This kept happening. Butter, milk, rice — always the wrong store at the wrong time. By month's end: €150-200 wasted. That's a weekend trip to Prague. Gone on groceries.",
      block4Title: "The Fix",
    ...
    de: {
      heroHeadline: "Ich habe jeden Monat €200 mehr ausgegeben als nötig. Jeden. Einzelnen. Monat.",
      heroSubtitle: "So habe ich das geändert.",
      block1Title: "Die Ankunft",
      block1Text: "Vor drei Jahren bin ich von Indien nach Deutschland gezogen. Kein Wort Deutsch. Einkaufen war der Horror. Ich stand bei Aldi vor Regalen voller Etiketten, die ich nicht lesen konnte, und hoffte einfach, dass es kein Katzenfutter war. 😰",
      ...
      block3Continues: "Das passierte immer wieder. Butter, Milch, Reis — immer der falsche Laden zur falschen Zeit. Am Monatsende: €150-200 verschwendet. Das ist ein Wochenendtrip nach Prag. Weg für Lebensmittel.",
